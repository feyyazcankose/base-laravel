  ...
  return (
    ...
    >
      <NavLink
        className={({ isActive }) =>
          cn(
            'flex transform items-center rounded-lg rounded-r-none px-3 py-2 text-gray-200 transition-colors duration-300 hover:bg-gray-50 hover:text-primary hover:dark:text-black ',
